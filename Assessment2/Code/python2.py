...
def four(input1, input2):
    if len(input1) != len(input2):
        ...
        return "".join(i for j in zip(input1, input2) for i in j)
...
def six(input):
	if input.casefold()[-1] == "y" and input.casefold()[-2] == "p":
		return True
	else:
		return False
...
def seven(a, b, c):
	if abs(a - b) % 2 == 0 or abs(b - a) % 2 == 0 == abs(b - c) % 2 == 0 or abs(c - b) % 2 == 0:
		return True
	elif abs(a - b) % 2 == 0 or abs(b - a) % 2 == 0 != abs(b - c) % 2 == 0 or abs(c - b) % 2 == 0:
		return False
